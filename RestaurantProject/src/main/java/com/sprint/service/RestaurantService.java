...
public interface RestaurantService {
	...
	//void getTablesAvailableOnDateTime(Date date, int duration);
	List<Restaurant> getTablesAvailableOnDateTime(LocalDate date, LocalTime startTime, LocalTime endTime);
}
