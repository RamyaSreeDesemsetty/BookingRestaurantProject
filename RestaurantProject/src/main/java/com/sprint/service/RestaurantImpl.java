...
//	@Override
//	public List<Restaurant> getTablesBySeating(int seatingCapacity) {
//		
//		return restaurantRepository.findBySeatingCapacity(seatingCapacity);
//	}
//	
	@Override
	...
	@Override
	public List<Restaurant> getTablesAvailableOnDateTime(LocalDate date,LocalTime time,LocalTime endTime) {
		
		return restaurantRepository.findTablesOnDateTime(date,time, endTime);
	}
